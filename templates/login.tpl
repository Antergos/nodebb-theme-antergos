    ...
    <div class="<!-- IF alternate_logins -->col-md-6<!-- ELSE -->col-md-12<!-- ENDIF alternate_logins -->">
        <div class="well well-lg">
            <div class="alert alert-info" id="login-info-notify" style="display:block">
                ...
                <p>All user accounts were imported from the old forum. For security reasons, passwords were not
                    imported. In order to activate your account on the new forum, you must reset your password by
                    selecting the <strong>Forgot Password</strong> link below.</p>
            </div>
            <div class="alert alert-danger" id="login-error-notify"
            <!-- IF error -->style="display:block"<!-- ELSE -->style="display: none;"<!-- ENDIF error -->>
            <button type="button" class="close" data-dismiss="alert">&times;</button>
        ...
        <form class="form-horizontal" role="form" method="post" target="login" id="login-form">
            <div class="form-group">
                ...
                <div class="col-lg-10">
                    <input class="form-control" type="text" placeholder="[[login:username]]" name="username"
                           id="username" autocorrect="off" autocapitalize="off"/>
                </div>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                <div class="col-lg-offset-2 col-lg-10">
                    ...
                    <span>[[login:dont_have_account]] <a
                            href="{relative_path}/register">[[register:register]]</a></span>
...
<div class="<!-- IF allowLocalLogin -->col-md-6<!-- ELSE -->col-md-12<!-- ENDIF allowLocalLogin -->">
    <div class="well well-lg">
        ...
        <ul class="alt-logins">
            ...
            <li class="{authentication.name}"><a rel="nofollow" href="{relative_path}{authentication.url}"><i
                    class="fa {authentication.icon} fa-3x"></i></a></li>
            <!-- END authentication -->
        </ul>
    </div>
</div>
