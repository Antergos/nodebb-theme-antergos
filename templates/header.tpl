...
<head>
	...
	<link rel="stylesheet" id="divi-style-css" href="http://antergos.org/wp-content/themes/Divi-Antergos/style.css?ver=2.2" type="text/css" media="all">
...
padding-right: 39px
	...
	h1, h2, h3, h4, h5, h6 { font-family: 'Raleway', Helvetica, Arial, Lucida, sans-serif !important; }body, input, textarea, select { font-family: 'Lato', Helvetica, Arial, Lucida, sans-serif !important; }
	</style>
	<!-- IF useCustomJS -->
	{customJS}
	<!-- ENDIF useCustomJS -->
