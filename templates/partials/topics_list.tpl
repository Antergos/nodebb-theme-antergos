				...
				<div class="col-md-8 col-sm-9">
					...
					<div class="category-text">
						<p>
							...
							<small>
								<a href="{config.relative_path}/category/{topics.category.slug}"><i class="fa {topics.category.icon}"></i> {topics.category.name}
								</a> &bull; <span class="timeago" title="{topics.relativeTime}"></span>
								<!-- IF !topics.unreplied -->
