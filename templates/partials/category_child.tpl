			<div class="<!-- IF children.class -->col-md-3 col-sm-6 col-xs-12 child-cat<!-- ELSE -->col-md-3 col-sm-6 col-xs-12<!-- ENDIF children.class --> category-item" data-cid="{children.cid}" data-numRecentReplies="{children.numRecentReplies}">
